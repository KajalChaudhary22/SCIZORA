 ...
 <div class="sidebar">
        <div class="sidebar-header">
            <div class="brand-name"><a href="#" class="text-xl md:text-2xl font-bold"><img src="<?php echo e(asset('build/images/logo.jpg')); ?>" alt="logo" width="200" height="60"></a></div>
    ...
    </div><?php /**PATH C:\KajalProjects\SCIZORA\resources\views/admin/layouts/sidebar.blade.php ENDPATH**/ ?>